...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["scripts/api_replacement_auth_smoke.py"], True),
        (["scripts/api_media_storage_smoke.py"], True),
        (["scripts/api_deployment_identity.py"], True),
        (["scripts/api_staging_promote.py"], True),
        (["scripts/api_staging_preflight.py"], True),
        (["scripts/api_development_delivery_event.py"], True),
        (["scripts/api_staging_reset.py"], True),
        (["scripts/api_staging_reset_ssh.py"], True),
        (["scripts/api_staging_fixture_diagnose.py"], True),
        (["scripts/api_staging_managed_auth_diagnose.py"], True),
        (["scripts/api_staging_managed_auth_diagnose_ssh.py"], True),
        (["scripts/api_staging_managed_operator_replace_ssh.py"], True),
        (["scripts/api_staging_managed_password_rotate_ssh.py"], True),
        (["scripts/api_staging_operator_inspect.py"], True),
        (["scripts/api_staging_operator_inspect_ssh.py"], True),
        (["scripts/api_staging_operator_lifecycle_ssh.py"], True),
        (["scripts/api_staging_operator_matrix.py"], True),
        (["scripts/api_staging_operator_matrix_ssh.py"], True),
        (["scripts/api_staging_registry_reconcile.py"], True),
        (["scripts/api_staging_registry_reconcile_remote.py"], True),
        ...
        ([".github/workflows/post-deploy-smoke.yml"], True),
        ([".semgrepignore"], True),
