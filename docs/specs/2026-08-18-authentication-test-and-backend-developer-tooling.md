...
identifiers, sensitive claims, raw HTTP bodies, request headers, or raw
exception representations. A combined failure reports both sanitized stage
categories without their sensitive details.
