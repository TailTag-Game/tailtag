...
The founding cohort is helping establish the product, architecture, development workflow, design system, testing practices, documentation, and community structure for the TailTag rebuild.
